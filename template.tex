...
{title=Theorem \thetcbcounter\maybep{#1}: ,drop lifted shadow=black,enhanced,colframe=yellow!10,colback=yellow!50!denisBicep!50,attach title to upper = {\ },
...
\draw[larratBicep!50!white!40] ([yshift = -0.35cm]interior.north west) -- (interior.north west);
\draw[larratBicep!35!white!40] ([yshift = -0.35cm]interior.north west) -- ([xshift = 0.45cm]interior.north west);
\draw[larratBicep!35!white!40] ([xshift = 0.45cm]interior.north west) -- (interior.north west);
}
}
